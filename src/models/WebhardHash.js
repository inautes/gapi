...
const remoteWebhardHash = sequelize.define('WebhardHash', {
  seq_no: {
...
const localWebhardHash = localSequelize.define('WebhardHash', {
  seq_no: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    allowNull: false,
...
const WebhardHash = remoteWebhardHash;
WebhardHash.local = localWebhardHash;
